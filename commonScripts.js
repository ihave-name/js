...
function showModal(id, hide_selects, unsupportedTlds) {
  const sections = {
    ppSection1: document.querySelector(
      ".white_inner_bg_container.white_inner_bg_container1",
    ),
    ppSection2: document.querySelector(
      ".white_inner_bg_container.white_inner_bg_1",
    ),
    dpsDesc1: document.querySelector(".without_description"),
    domainSection1: document.querySelector(
      ".white_inner_bg_container.white_inner_bg_2",
    ),
    domainSection2: document.querySelector(
      ".white_inner_bg_container.white_inner_bg_container2",
    ),
  ...
  if (unsupportedTlds === true) {
    ...
    toggleDisplay(
      [
        sections.tcSection1,
        sections.tcSection2,
        sections.noteSection1,
        sections.noteSection2,
      ],
      "block",
    );
...
validZip = function (value, country, callback) {
  ...
  if (
    zipValidationCache[country] !== undefined &&
    zipValidationCache[country][value] !== undefined
  ) {
