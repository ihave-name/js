...
$(window).load(function () {
  ...
  try {
    ...
    if (customerID != undefined && customerID != "") {
      typeof dataLayerCustomerLogin != "undefined"
  ...
  if (sessionStorage.originaluserId != undefined) {
    ...
    $("#pay_debit_button, #pay_gateway_button, #pay_offline_button").click(
      function () {
        ...
        typeof dataLayerMeasuringCheckout != "undefined"
    ...
    if (
      ...
      if (
        typeof dataLayerOrderPlaced != "undefined" &&
        typeof dataLayerPurchase != "undefined"
      ) {
        $.ajax({
          type: "GET",
      ...
      if (typeof dataLayerAutoRenewCartItemUpdate != "undefined") {
        $.ajax({
          ...
          success: function (result) {
            ...
            dataLayerAutoRenewCartItemUpdate
