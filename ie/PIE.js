  ...
  if (!f) {
    ...
    for (
      var X = 4,
        ...
        ca = Y.getElementsByTagName("i"),
        Z;
      (Y.innerHTML = "<!--[if gt IE " + ++X + "]><i></i><![endif]-->"), ca[0];
            ...
            if (g.charAt(j.length) === "(") {
              ...
              if (j.toLowerCase() in this.fd) {
                ...
                if (
                  ...
                  return d(b.B, this.$a.substring(i, this.ch));
                return e();
              }
              return d(b.Xb, j);
            }
      ...
      f.C = {
        ...
        ia: a(function () {
          ...
          var e = this.va,
            ...
            i = c.Yc || (c.Yc = f.Q + e);
          c =
            c.Zc || (c.Zc = f.nb + g.charAt(0).toUpperCase() + g.substring(1));
          ...
          for (i = {}; (g = e.next()); ) {
            ...
            if (!i.N && l & j.Xb && q === "linear-gradient") {
              ...
              for (p = {}; (g = e.next()); ) {
                ...
                } else if (l & j.Ia && !r.ra && !p.color && !r.ca.length)
                  r.ra = new f.Ec(g.d);
                else if (b(g) && !r.zb && !p.color && !r.ca.length) {
                  e.D();
                  r.zb = new f.Ja(
                    e.la(function (v) {
                      return !b(v);
              ...
              if (q in this.fb && !i.bb) i.bb = q;
              else if (q in this.sc && !i.Wa) {
                i.Wa = q;
                if ((g = e.next()) && g.k & k && g.d in this.sc) i.ub = g.d;
                else {
                  i.ub = q;
                  e.D();
                }
              } else if (q in this.cd && !i.bc) i.bc = q;
              else return null;
            else if (l & n && !t.color) t.color = f.ha(q);
            else if (l & h && q === "/" && !i.Xa && i.$) {
              g = e.next();
              if (g.k & k && g.d in this.Td) i.Xa = new f.Ka(g.d);
              else if ((g = c(g))) {
                l = c(e.next());
                if (!l) {
                  l = g;
      ...
      qc: function () {
        ...
        if (f.V < 7) {
          ...
          a =
            "" +
              (a.style[f.nb + "PngFix"] ||
                a.currentStyle.getAttribute(f.Q + "png-fix")) ===
            "true";
        }
        return a;
      },
    ...
    f.Vb = f.C.ja({
      ...
      Hd: { thin: "1px", medium: "3px", thick: "5px" },
      ka: function () {
        var a = {},
          b = {},
          c = {},
        ...
        this.Cc(function () {
          for (
            var j = this.e.currentStyle, h = 0, k, n, l, q, s, m, r;
            h < 4;
            h++
          ) {
            l = this.wc[h];
          ...
          for (
            var s = function (p) {
              ...
              r = function () {
                ...
                if (m(c.next()) && !b.fill) b.fill = true;
                else c.D();
                if (s(c.next())) {
                  h++;
                  i = c.la(function (p) {
          ...
          for (
            a = function () {
              for (var g, i, j, h, k, n; (g = e.next()); ) {
                ...
                else if (i & d.ma && j === "inset" && !n) n = true;
                else return false;
              }
              g = k && k.length;
              if (g > 1 && g < 5) {
    ...
    f.u = {
      ...
      sb: function (a, b) {
        this.vc(a);
        for (
          var c = this.qa || (this.qa = []), d = a + 1, e = c.length, g;
          d < e;
          d++
        )
          if ((g = c[d])) break;
      ...
      mc: function () {
        var a = this.e,
          ...
          g;
        if (
          (e && (d in f.cc || d === "FIELDSET")) ||
          d === "BUTTON" ||
          (d === "INPUT" && a.type in f.Gd)
        ) {
          c.borderWidth = "";
          d = this.g.z.wc;
          for (g = d.length; g--; ) {
    ...
    f.Fc = f.u.P({
      ...
      pd: function () {
        ...
        if (a) {
          ...
          for (i = a.length; i--; ) {
            ...
            g.width = d;
            g.height = e;
            if (b.N === "linear-gradient") this.bd(c, b);
            else {
              c.fill.src = b.Ab;
              this.Md(c, i);
            }
      ...
      Md: function (a, b) {
        ...
        f.p.Rb(a.fill.src, function (d) {
          ...
          if (i && g) {
            ...
            h = h.w.j().L[b];
            e = h.$
              ? h.$.coords(e, i - d.i - n - l, g - d.f - k - q)
              : { x: 0, y: 0 };
            h = h.bb;
            q = l = 0;
            var s = i + 1,
      ...
      bd: function (a, b) {
        ...
        for (h = 0; h < i; h++)
          k.push(
            d[h].db ? d[h].db.a(c, b) : h === 0 ? 0 : h === i - 1 ? b : null
          );
        for (h = 1; h < i; h++) {
          if (k[h] === null) {
            l = k[h - 1];
        ...
        for (h = 0; h < i; h++)
          j.push(n + (k[h] / g) * 100 + "% " + d[h].color.T(c));
        a.angle = e;
        a.type = "gradient";
        a.method = "sigma";
        a.color = d[0].color.T(c);
        a.color2 = d[i - 1].color.T(c);
        if (a.colors) a.colors.value = j.join(",");
        else a.colors = j.join(",");
      },
      lc: function () {
            ...
            if (i.stroke) {
              ...
              e.dashstyle =
                i.stroke === "dashed"
                  ...
                  : "solid";
              e.linestyle =
                i.stroke === "double" && i.Qb > 2 ? "ThinThin" : "Single";
        ...
        if (g.h()) {
          ...
          if (c.de && c.Zd && c.hd) {
            if (m.t.fa() > 0) {
              ...
              k = c / 2;
              i.push({
                path: this.xa({ Jb: k, Ib: k, tb: k, Db: k }, a),
                stroke: s.t,
                color: m.t,
                Qb: c,
              });
              ...
              v = function (o, u, x, y) {
                var z =
                  o === "t"
                    ...
                    ? h(d - u) * a + "," + j(p("y", "tr")) * a
                    : o === "b"
                    ? h(d - p("x", "br")) * a + "," + j(e - u) * a
                    : j(u) * a + "," + h(e - p("y", "bl")) * a;
                o =
                  o === "t"
                    ? h(d - p("x", "tr")) * a + "," + h(u) * a
                    : o === "r"
                    ? h(d - u) * a + "," + h(e - p("y", "br")) * a
                    : o === "b"
                    ? j(p("x", "bl")) * a + "," + j(e - u) * a
                    : j(u) * a + "," + j(p("y", "tl")) * a;
                return x
            ...
            b = function (o, u, x, y, z, D) {
              ...
              if (E > 0 && s[o] !== "none" && m[o].fa() > 0) {
                ...
                if (s[o] === "dashed" || s[o] === "dotted") {
                  i.push({
                    path: t(y, B, u, D + 45, 0, 1) + t(y, 0, 0, D, 1, 0),
                    fill: m[o],
                  });
                  i.push({
                    path: v(o, E / 2, 0, 1),
                  ...
                  i.push({
                    path: t(z, A, x, D, 0, 1) + t(z, 0, 0, D - 45, 1, 0),
                    fill: m[o],
                  });
                } else
                  i.push({
                    path:
                      ...
                      t(z, A, x, D, 0, 0) +
                      (s[o] === "double" && E > 2
                        ? t(z, A - j(A / 3), x - j(x / 3), D - 45, 1, 0) +
                          v(o, h((E / 3) * 2), 1, 0) +
                          t(y, B - j(B / 3), u - j(u / 3), D, 1, 0) +
                          "x " +
                          t(y, j(B / 3), j(u / 3), D + 45, 0, 1) +
                          v(o, j(E / 3), 1, 0) +
                          t(z, j(A / 3), j(x / 3), D, 0, 0)
                        : "") +
                      t(z, 0, 0, D - 45, 1, 0) +
                      v(o, 0, 1, 0) +
                      t(y, 0, 0, D, 1, 0),
    ...
    f.Oc = f.u.P({
      ...
      ab: function () {
        ...
        if (
          a &&
          (b = a.join(",").replace(this.Kd, "").replace(this.Fd, ",")) !==
            this.Wc
        )
    ...
    f.Mc = f.u.P({
      ...
      U: function () {
        ...
        if (a) {
          ...
          if ((c = a.L))
            for (; (e = c[d++]); )
              if (e.N === "linear-gradient") {
                g = this.vd(e.Wa);
                g = (e.Xa || f.Ka.Kc).a(this.e, g.i, g.f, g.i, g.f);
                b.push(
                  "url(data:image/svg+xml," +
                    escape(this.xd(e, g.i, g.f)) +
                    ") " +
                    this.dd(e.$) +
                    " / " +
                    g.i +
      ...
      xd: function (a, b, c) {
        ...
        for (l = 0; l < g; l++)
          n.push(
            e[l].db ? e[l].db.a(d, i) : l === 0 ? 0 : l === g - 1 ? i : null
          );
        for (l = 1; l < g; l++)
          if (n[l] === null) {
            s = n[l - 1];
    ...
    f.kb = (function () {
      ...
      function b(m) {
        var r = s.slice.call(arguments, 1),
          p = r.length;
        setTimeout(function () {
          for (; p--; ) a(m, r[p]);
        }, 0);
        ...
        function r() {
          if (!R) {
            ...
            if (!Q) {
              ...
              O = m;
              for (var ba = 1; (O = O.previousSibling); )
                if (O.nodeType === 1) {
                  ba = 0;
                  break;
                }
      ...
      var e = {},
        ...
        k = f.La + "focus",
        n = f.La + "first-child",
        l = { background: 1, bgColor: 1, display: 1 },
        q = {},
        s = [];
      d.yd = function (m) {
        var r = f.p.Aa(m);
